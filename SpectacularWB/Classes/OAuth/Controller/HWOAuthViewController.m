...
- (void)viewDidLoad
{
     ...
     */
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=2981236934&redirect_uri=http://"];
...
- (void)accessTokenWithCode:(NSString *)code
{
    ...
    params[@"client_id"] = @"2981236934";
    params[@"client_secret"] = @"963c5eb7bc1a423754949f43d67386c1";
